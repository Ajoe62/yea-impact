...
- `app/` — routes, pages, and feature-level server/client code.
...
- `utils/supabase/` — Supabase client factories for server and browser.
...
- For major structural changes, include a short “Architecture Notes” section.
...
- Don’t move secret-aware logic into client components.
- Don’t bypass RLS assumptions with unsafe query patterns.
- Don’t introduce new global styles for one-off component needs.
- Don’t commit temporary files, dead experiments, or commented-out legacy blocks.
