        ...
        <div className="container mx-auto relative z-10">
          <AnimatedSection animation="fadeIn">
            ...
            <p className="text-xl opacity-90 max-w-xl mb-8">
              Explore job openings from our partner companies and organizations
              committed to supporting young professionals
            </p>
          </AnimatedSection>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 mb-4">
                Get tips and templates for crafting a resume that stands out to
                employers.
              </p>
              <Link
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              ...
              <h3 className="text-lg font-bold mb-2">Networking Strategies</h3>
              <p className="text-gray-600 mb-4">
