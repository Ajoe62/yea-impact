...
export default async function EventsPage() {
  ...
  const { data: events } = await supabase
    .from("events")
    .select(
      "id, title, description, event_date, location, image_url, category, organizer, capacity"
    )
          ...
          <div className="container mx-auto relative z-10">
            <AnimatedSection animation="fadeIn">
              ...
              <p className="text-xl opacity-90 max-w-xl mb-8">
                Join us for workshops, networking events, and community
                gatherings that inspire growth and connection
              </p>
            </AnimatedSection>
            ...
            <AnimatedSection animation="slideUp" delay={0.1}>
              <div className="flex flex-wrap gap-4">
                <Link
                  href="#upcoming"
                  className="px-6 py-3 bg-white text-green-700 rounded-lg font-bold hover:shadow-lg transition-shadow"
                >
                  Browse Events
                </Link>
                <Link
            ...
            <AnimatedSection animation="fadeIn">
              <div className="text-center py-16 bg-gray-50 rounded-2xl">
                ...
                <p className="text-gray-600 max-w-md mx-auto mb-6">
                  There are no upcoming events at the moment. Check back soon or
                  subscribe to be notified when new events are added.
                </p>
                <Link
                  href="/contact"
              ...
              <div className="relative z-10 md:flex items-center justify-between">
                <div className="mb-6 md:mb-0">
                  ...
                  <p className="text-blue-100 max-w-xl">
                    Partner with us to organize workshops, talks, or networking
                ...
                <Link
                  href="/contact"
                  className="inline-block px-8 py-3 bg-white text-blue-600 rounded-lg font-bold hover:shadow-xl transition-shadow"
                >
                  Get in Touch
                </Link>
              </div>
