        ...
        <AnimatedSection animation="fadeIn">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              ...
              courses. From beginner to advanced, we offer learning paths to
          ...
          <AnimatedSection animation="fadeIn" delay={0.4}>
            <div className="bg-gradient-to-r from-green-700 to-teal-700 rounded-xl p-8 text-white text-center">
              ...
              <p className="mb-6 max-w-2xl mx-auto">
                ...
                mastering new digital skills. Our courses are designed to help
                you succeed in today's digital economy.
              </p>
              <Link
                href="/login"
