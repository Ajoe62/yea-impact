...
export default async function MentorshipPage() {
  ...
  const { data: mentors } = await supabase
    .from("mentors")
    .select(
      "id, bio, expertise, years_experience, available_hours, profile_image, social_links, area, profiles:profiles(display_name)"
    )
    ...
    <PageWrapper>
      <div className="space-y-16">
            ...
            <AnimatedSection animation="fadeIn">
              <div className="max-w-3xl mx-auto text-center mb-10">
                ...
                <p className="text-xl text-gray-600 mb-8">
                  Connect with industry professionals who can help guide your
                  career, share knowledge, and support your growth journey.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link
                    href="#mentors"
                    className="px-8 py-3 bg-green-600 text-white rounded-md hover:bg-green-700 transition-all shadow-md font-medium text-lg"
                  >
                    Browse Mentors
                  </Link>
                  <Link
                    href="/mentorship/apply"
                    className="px-8 py-3 bg-white text-green-600 border border-green-600 rounded-md hover:bg-green-50 transition-all font-medium text-lg"
                  >
                    Become a Mentor
                  </Link>
                </div>
          ...
          <div className="absolute bottom-0 left-0 right-0 h-16">
            ...
            >
              <path
                fill="#ffffff"
                fillOpacity="1"
                d="M0,96L48,106.7C96,117,192,139,288,149.3C384,160,480,160,576,138.7C672,117,768,75,864,74.7C960,75,1056,117,1152,117.3C1248,117,1344,75,1392,53.3L1440,32L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"
              ></path>
            </svg>
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <AnimatedSection animation="slideUp" delay={0.1}>
              <div className="text-center p-8 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 relative">
                ...
                <p className="text-gray-600">
                  Browse our mentor profiles and find someone who aligns with
            ...
            <AnimatedSection animation="slideUp" delay={0.2}>
              <div className="text-center p-8 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 relative">
                ...
                <p className="text-gray-600">
                  Send a request, schedule an initial meeting, and develop a
            ...
            <AnimatedSection animation="slideUp" delay={0.3}>
              <div className="text-center p-8 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
                ...
                <p className="text-gray-600">
                  Engage in regular sessions, work on your goals, and track your
                  progress over time.
                </p>
                ...
                <ul className="mt-4 text-sm text-left text-gray-600 space-y-2">
                  <li className="flex items-start">
                    <svg
                      className="w-4 h-4 text-purple-500 mt-0.5 mr-2 flex-shrink-0"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                      <path
        ...
        <section className="relative py-16">
          <div
            className="absolute inset-0 bg-gradient-to-r from-gray-50 to-gray-100 skew-y-3 z-0"
          ...
          <div className="container mx-auto relative z-10">
            <AnimatedSection animation="fadeIn">
              ...
              <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">
                Our mentors specialize in these high-impact areas to help you
                develop valuable skills and advance your career
              </p>
            </AnimatedSection>
            ...
            <AnimatedSection animation="fadeIn" delay={0.6}>
              <div className="text-center mt-10">
                <Link
                  href="/mentorship/areas"
                  className="inline-block px-6 py-3 bg-white text-blue-600 border border-blue-600 rounded-md hover:bg-blue-50 transition-colors duration-300 font-medium"
                >
                          ...
                          {mentor.profile_image ? (
                            ...
                            <div className="absolute inset-0 bg-gradient-to-br from-green-100 to-blue-100 flex items-center justify-center">
                              <span className="text-4xl text-gray-400">
                                {getDisplayName(mentor).charAt(0)}
                              </span>
                            </div>
                          )}
                    ...
                    <div className="flex flex-wrap items-center justify-between mb-6">
                      <p className="text-gray-600 font-medium">
                        <span className="text-green-700 font-bold">
                          {mentorsByArea[area].length}
                        </span>{" "}
                        mentors available in this category
                      </p>
                          ...
                          >
                            ...
                            <div className="flex-1">
                              <div className="flex justify-between items-start">
                                ...
                                <svg
                                  className="w-5 h-5 text-gray-400 hover:text-green-600 transition-colors flex-shrink-0"
                                  fill="none"
                                  stroke="currentColor"
                                  viewBox="0 0 24 24"
                                >
                              ...
                              <div className="flex justify-between items-center mt-2">
                                <span className="text-xs text-gray-500">
                                  {mentor.available_hours
                                    ? `${mentor.available_hours} hrs/week`
                                    : "Schedule flexible"}
                                </span>
                    ...
                    {mentorsByArea[area].length > 6 && (
                      <div className="flex justify-center mt-8">
                        <button className="px-6 py-2 border border-gray-300 rounded-md text-sm font-medium hover:border-green-500 hover:text-green-700 transition-colors flex items-center">
                          View all {mentorsByArea[area].length} mentors in{" "}
                          {area}
                          <svg
                            className="w-4 h-4 ml-1"
                            fill="none"
            ...
            <AnimatedSection animation="fadeIn">
              <div className="text-center py-16 bg-gradient-to-br from-gray-50 to-green-50 rounded-xl border border-dashed border-green-200">
                <div className="max-w-lg mx-auto">
                  <svg
                    className="w-20 h-20 mx-auto text-green-300 mb-6"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p className="text-gray-600 mb-6 leading-relaxed">
                    We're currently onboarding mentors to our platform. Check
                    back soon or sign up to be notified when mentors become
                    available. You can also apply to become a mentor yourself!
                  </p>
            ...
            <div className="container mx-auto px-4 relative z-10">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <p className="text-green-50 text-lg mb-8 leading-relaxed">
                  Whether you're looking to develop new skills, advance your
                  career, or give back by sharing your knowledge, our mentorship
                  program is designed to help you succeed.
                </p>

                <div className="flex flex-col sm:flex-row justify-center gap-4">
                  <Link
                    href="/mentorship/find"
                    className="px-8 py-4 bg-white text-green-700 rounded-lg shadow-lg hover:shadow-xl transition-shadow font-bold text-lg"
                  >
                    Find a Mentor
                  </Link>
                  <Link
                    href="/mentorship/become"
                    className="px-8 py-4 bg-green-700 text-white rounded-lg shadow-lg hover:shadow-xl transition-shadow font-bold text-lg"
                  >
                    Become a Mentor
                  </Link>
                </div>
