...
export const metadata: Metadata = {
  ...
  description:
    "Empowering African youths through mindset reorientation, skills training, mentorship and industry connections.",
};
        ...
        <footer className="bg-gray-100 pt-10 pb-6">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Youth Empowerment Africa is dedicated to empowering young
            ...
            <div className="pt-6 border-t border-gray-200 text-center text-sm text-gray-600">
              © {new Date().getFullYear()} Youth Empowerment Africa. All rights
              reserved.
            </div>
          </div>
        </footer>
